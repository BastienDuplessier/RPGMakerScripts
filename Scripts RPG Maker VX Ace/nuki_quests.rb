...
module Quest_Config
  ...
  #--------------------------------------------------------------------------
  DEFAULT_SUCESS = lambda{|name| "#{name} : réussie!"}
  #--------------------------------------------------------------------------
  # * Message d'échec par défaut
  #--------------------------------------------------------------------------
  DEFAULT_FAIL = lambda{|name| "#{name} : échouée!"}
  #--------------------------------------------------------------------------
...
module Vocab
  class << self
    ...
    def quest_incurse;   "En cours";    end
    def quest_success;   "Validées";    end
    def quest_fail;      "Echouées";    end
    def quest_pended;    "Completées";  end
    def quest_buy;       "Acheter";     end
    def quest_confirm;   "Confirmer";   end
    def quest_cancle;    "Retour";      end
    def quest_gold;       "#{Vocab::currency_unit} donnés"; end
    def quest_exp;        "Exp donnée"; end
    def quest_items;      "Objets donnés"; end
  end
end
